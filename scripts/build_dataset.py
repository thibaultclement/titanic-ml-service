...
def build_dataset():
    ...
    save_dataset(df_raw, "data/interim/titanic_merged.parquet")

    df_cleaned = clean_data(df_raw)

    save_dataset(df_cleaned, "data/processed/titanic_cleaned.parquet")

    df_features = build_features(df_cleaned)
    df_features = add_survival_rate_features(df_features)

    save_dataset(df_features, "data/processed/titanic_features.parquet")
